...
project ("osd_" .. _OPTIONS["osd"])
	...
	files {
		...
		MAME_DIR .. "src/osd/modules/debugger/win/luawininfo.cpp",
		MAME_DIR .. "src/osd/modules/debugger/win/luawininfo.h",
		MAME_DIR .. "src/osd/modules/debugger/win/luaviewinfo.cpp",
		MAME_DIR .. "src/osd/modules/debugger/win/luaviewinfo.h",
