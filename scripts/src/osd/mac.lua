...
project ("osd_" .. _OPTIONS["osd"])
	...
	files {
		...
		MAME_DIR .. "src/osd/modules/debugger/osx/lualogview.mm",
		MAME_DIR .. "src/osd/modules/debugger/osx/lualogview.h",
		MAME_DIR .. "src/osd/modules/debugger/osx/luaviewer.mm",
		MAME_DIR .. "src/osd/modules/debugger/osx/luaviewer.h",
