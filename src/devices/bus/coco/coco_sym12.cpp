...
namespace
{
	...
	public:
		...
		coco_symphony_twelve_device(const machine_config &mconfig, const char *tag, device_t *owner, u32 clock)
			: device_t(mconfig, COCO_SYMPHONY_TWELVE, tag, owner, clock)
...
DEFINE_DEVICE_TYPE_PRIVATE(COCO_SYMPHONY_TWELVE, device_cococart_interface, coco_symphony_twelve_device, "coco_symphony_twelve", "Speech Systems Symphony Twelve")
